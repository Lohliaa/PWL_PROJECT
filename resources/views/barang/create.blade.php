    ...
    <div class="row justify-content-center align-items-center">
        <div class="card" style="width: 24rem;">
            ...
            <div class="card-body">
                ...
                @endif
                <form method="post" enctype="multipart/form-data" action="{{ route('barang.store') }}" id="myForm">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="jenis_barang" name="jenis_barang" class="form-control" id="jenis_barang"
                            aria-describedby="jenis_barang">
                    </div>
                    <div class="form-group">
