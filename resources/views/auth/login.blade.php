...
<head>
    ...
    <title>
        Welcome To Service Motor
    </title>
    <!--     Fonts and icons     -->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700" rel="stylesheet" />
    <!-- Nucleo Icons -->
    <link href="{{ asset('templatedashboard/assets/css/nucleo-icons.css') }}" rel="stylesheet" />
    <link href="{{ asset('templatedashboard/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- Font Awesome Icons -->
    <script src="https://kit.fontawesome.com/42d5adcbca.js" crossorigin="anonymous"></script>
    <link href="{{ asset('templatedashboard/assets/css/nucleo-svg.css') }}" rel="stylesheet" />
    <!-- CSS Files -->
    <link id="pagestyle" href="{{ asset('templatedashboard/assets/css/argon-dashboard.css?v=2.0.2') }}"
        rel="stylesheet" />
</head>
...
<body class="">
                                    ...
                                    <form method="POST" action="{{ route('login') }}">
                                        ...
                                        <form role="form">
                                            ...
                                            <div class="text-center">
                                                <button type="submit"
                                                    class="btn btn-lg btn-primary btn-lg w-100 mt-4 mb-0">{{ __('Sign
                                                    In')}}</button>
                                            </div>
                                        </form>
                                </div>
    ...
    <script src="{{ asset('templatedashboard/assets/js/plugins/perfect-scrollbar.min.js') }}"></script>
    <script src="{{ asset('templatedashboard/assets/js/plugins/smooth-scrollbar.min.js') }}"></script>
    <script>
    ...
    <script src="{{ asset('templatedashboard/assets/js/argon-dashboard.min.js?v=2.0.2') }}"></script>
</body>
